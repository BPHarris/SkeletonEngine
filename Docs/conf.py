...
project = u'SkeletonEngine'
copyright = u'2020, BP Harris'
author = u'BP Harris'
...
exhale_args = {
    ...
    'rootFileName': 'skeleton_engine.rst',
    'rootFileTitle': 'SkeletonEngine API',
    ...
    'exhaleDoxygenStdin': 'INPUT = ../SkeletonEngine/src'
}
...
htmlhelp_basename = 'SkeletonEnginedoc'
...
latex_documents = [
    (master_doc, 'SkeletonEngine.tex', u'SkeletonEngine Documentation',
     u'BP Harris', 'manual'),
]
...
man_pages = [
    (master_doc, 'skeletonengine', u'SkeletonEngine Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SkeletonEngine', u'SkeletonEngine Documentation',
     author, 'SkeletonEngine', 'One line description of project.',
     'Miscellaneous'),
]
