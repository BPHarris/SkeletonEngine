...
.. _file_SkeletonEngine_src_SkeletonEngine_LayerStack.h:
...
SkeletonEngine layer stack interface. 
...
Definition (``SkeletonEngine\src\SkeletonEngine\LayerStack.h``)
---------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_SkeletonEngine_src_SkeletonEngine_LayerStack.h.rst
...
- ``Layer.h`` (:ref:`file_SkeletonEngine_src_SkeletonEngine_Layer.h`)
